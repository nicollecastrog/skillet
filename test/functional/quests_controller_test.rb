...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { name: @quest.name, points_worth: @quest.points_worth, status: @quest.status }
    end
  ...
  test "should update quest" do
    put :update, id: @quest, quest: { name: @quest.name, points_worth: @quest.points_worth, status: @quest.status }
    assert_redirected_to quest_path(assigns(:quest))
  end
